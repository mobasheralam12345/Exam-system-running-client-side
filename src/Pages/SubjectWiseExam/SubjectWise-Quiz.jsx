...
const SubjectWiseQuiz = ({ subject, totalQuestions }) => {
    ...
    useEffect(() => {
        const fetchQuestions = async () => {
            setLoading(true);
            try {
                const response = await axios.get(`http://localhost:5000/bcs-questions/get-questions/${subject}/${totalQuestions}`);
...
const handleSubmit = async () => {
    ...
    try {
        await axios.post('http://localhost:5000/bcs-questions/save-subject-wise-history', dataToSend);
...
export default SubjectWiseQuiz;