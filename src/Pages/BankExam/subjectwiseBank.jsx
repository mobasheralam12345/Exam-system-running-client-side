        ...
        <div className="bg-card backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl border border-border">
          ...
          <div className="mt-8 p-4 bg-emerald-50 rounded-xl border border-emerald-100">
            <p className="text-sm text-muted-foreground">
              <strong className="text-accent">Note:</strong> Select your subject and specify how many questions you want to practice. The system will randomly select questions from the chosen subject.
            </p>
          </div>
        </div>
      </div>
