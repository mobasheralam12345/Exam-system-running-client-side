  ...
  const handleProceed = async () => {
    ...
    try {
      const response = await fetch(
        `${BACKEND_URL}/bank-questions/subject/${encodeURIComponent(
          selectedSubject
        )}/${numQuestions}`
      );
      ...
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 dark:text-white max-w-2xl mx-auto">
            Choose your subject and customize the number of questions to practice
          </p>
        </div>
        ...
        <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl border border-slate-200 dark:border-gray-700">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter number of questions (e.g., 50)"
          ...
          <div className="mt-8 p-4 bg-blue-50 dark:bg-gray-800 rounded-xl border border-blue-100 dark:border-gray-700">
            <p className="text-sm text-slate-600 dark:text-white">
              <strong className="text-blue-600 dark:text-blue-400">Note:</strong> Select your subject and specify how many questions you want to practice. The system will randomly select questions from the chosen subject.
            </p>
          </div>
        </div>
      </div>
...
export default BankQuestionSelector;
