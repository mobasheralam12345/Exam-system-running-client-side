...
export default function ExamDeskHomepage() {
  ...
  const stats = [
    ...
    { number: "50+", label: "Live Exams", icon: <Clock className="w-6 h-6" /> },
    {
      number: "95%",
      label: "Success Rate",
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl lg:text-2xl mb-8 text-slate-700 leading-relaxed">
                Your gateway to success in BCS, HSC, and Banking exams. Practice
                with confidence, excel with excellence.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-2xl mx-auto">
              Comprehensive exam preparation platform designed for Bangladeshi
              students
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-8 h-full border border-indigo-100 hover:border-indigo-200 transition-all duration-300 shadow-lg">
                  <div
                    className={`bg-gradient-to-r ${feature.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300 shadow-md`}
                  >
                    {feature.icon}
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              What our students say about ExamDesk BD
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join ExamDesk BD today and take the first step towards your dream
            career
          </p>
